...
// Codex (App Server over stdio), Claude (Code CLI headless), Grok (Build
// CLI headless), and Cursor (`@cursor/sdk`) all implement it; the job
// processor picks an implementation by job kind / config.
